---
layout: post
title: "2. MRI y la Arquitectura de Ruby: Entendiendo el Motor y la Necesidad de C"
tag: jekyll
---

<p>Hemos definido la Gema como un "Taller Especializado", pero ¿quién es la entidad principal que coordina a todos estos talleres? Aquí es donde entra el concepto del MRI, la implementación del lenguaje Ruby que usamos por defecto, y por qué a veces necesitamos recurrir a otros lenguajes como C.</p>

<hr>

<h2 id="ruby-vs-mri">1. No es lo Mismo: Ruby (El Lenguaje) que MRI (El Motor)</h2>
